...
from models.schemas import UserAnswers
...
# In-memory store for questions per file_id
questions_store = {}
...
async def get_questions(file_id: str):
    ...
    # Store questions for this file_id so /process can use column info
    questions_store[file_id] = questions
...
async def process_file(body: UserAnswers):
    ...
    # Get stored questions for column mapping
    questions = questions_store.get(body.file_id, [])
 
    cleaned_df, stats = process_dataframe(df, body.answers, questions)
